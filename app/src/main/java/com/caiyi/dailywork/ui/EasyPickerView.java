...
public class EasyPickerView extends View {
    ...
    public EasyPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextSize, (int) TypedValue
        ...
        textPadding = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextPadding, (int) TypedValue
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        contentHeight = (int)(textHeight * maxShowNum + textPadding * maxShowNum);
        if (mode != MeasureSpec.EXACTLY) { //wrap_content
    ...
    protected void onDraw(Canvas canvas) {
        if (dataList != null && dataList.size() > 0) {
            ...
            int centerPadding = (int) (textHeight + textPadding);
    ...
    private void setOnScrollChangedListener(OnScrollChangeListener onScrollChangedListener) {
